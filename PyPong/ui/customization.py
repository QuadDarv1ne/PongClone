...
class CustomizationManager:
    ...
    def _create_default_options(self) -> None:
        ...
        self.paddle_skins = {
            ...
            "neon": PaddleSkin(
                "neon", "Neon", (0, 255, 255), pattern="solid", unlocked=False, unlock_requirement="Complete campaign"
            ),
            "gold": PaddleSkin(
                "gold",
                "Gold",
        ...
        self.court_themes = {
            ...
            "dark": CourtTheme("dark", "Dark Mode", (20, 20, 20), (100, 100, 100), (80, 80, 80), (150, 150, 150)),
            "neon": CourtTheme(
                "neon", "Neon", (10, 10, 30), (0, 255, 255), (255, 0, 255), (0, 255, 255), unlocked=False
            ),
            "retro": CourtTheme("retro", "Retro", (0, 50, 0), (0, 255, 0), (0, 200, 0), (0, 255, 0), unlocked=False),
        }
    ...
    def save_customization(self) -> None:
        ...
        try:
            ...
            data = {
                ...
                "unlocked": {
                    "paddles": [skin_id for skin_id, skin in self.paddle_skins.items() if skin.unlocked],
                    "balls": [skin_id for skin_id, skin in self.ball_skins.items() if skin.unlocked],
                    "courts": [theme_id for theme_id, theme in self.court_themes.items() if theme.unlocked],
                },
            }
