...
class MenuItem:
    ...
    def __init__(self, text_key: str, action: Callable[[], None], 
                 shortcut: str = "", icon: str = ""):
...
class Menu:
    ...
    def add_item(self, text_key: str, action: Callable[[], None], 
                 shortcut: str = "", icon: str = ""):
        """Add menu item"""
    ...
    def _draw_title(self):
        ...
        for offset in range(3, 0, -1):
            ...
            glow_rect = glow_text.get_rect(
                center=(self.screen.get_width() // 2, 120 - offset * 2)
            )
