...
class TutorialManager:
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        self._draw_wrapped_text(
            screen, step.description, box_x + 30, box_y + 70, box_width - 60, Colors.WHITE.to_tuple()
        )
    ...
    def _draw_wrapped_text(
        self, screen: pygame.Surface, text: str, x: int, y: int, max_width: int, color: tuple[int, int, int]
    ) -> None:
