...
class TouchControls:
    ...
    def draw(self, surface):
        ...
        surface.blit(p1_down_text, (self.screen_width // 4 - p1_down_text.get_width() // 2, self.screen_height - padding - p1_down_text.get_height()))
        surface.blit(p2_up_text, (3 * self.screen_width // 4 - p2_up_text.get_width() // 2, padding))
        surface.blit(p2_down_text, (3 * self.screen_width // 4 - p2_down_text.get_width() // 2, self.screen_height - padding - p2_down_text.get_height()))
