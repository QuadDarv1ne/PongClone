...
class LocalLeaderboard:
    ...
    def add_or_update_entry(
        ...
        if existing:
            ...
            existing.win_rate = existing.wins / (existing.wins + existing.losses) if (existing.wins + existing.losses) > 0 else 0
...
class LeaderboardManager:
    ...
    def submit_score(
        ...
        # Always save locally
        self.local.add_or_update_entry(
            player_name, score, wins, losses, highest_combo, playtime
        )
