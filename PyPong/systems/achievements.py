...
class AchievementManager:
    ...
    def _create_achievements(self) -> None:
        ...
        achievements_data = [
            ...
            Achievement(
                "win_10", "Winning Streak", "Win 10 games", AchievementType.WIN_STREAK, 10, points=200, icon="🔥"
            ),
            Achievement("win_50", "Champion", "Win 50 games", AchievementType.WIN_STREAK, 50, points=500, icon="👑"),
            Achievement("win_100", "Legend", "Win 100 games", AchievementType.WIN_STREAK, 100, points=1000, icon="⭐"),
            # Perfect game achievements
            Achievement(
                "perfect_5",
                "Flawless",
                "Win without missing (score 5)",
            ...
            Achievement(
                ...
                AchievementType.POWER_COLLECTOR,
                10,
                points=150,
                icon="💪",
            ),
            ...
            Achievement(
                ...
                AchievementType.CAMPAIGN_COMPLETE,
                5,
                points=500,
                icon="🗺️",
            ),
            ...
            Achievement(
                ...
                AchievementType.MINIGAME_EXPERT,
                5,
                points=1000,
                icon="🎮",
            ),
    ...
    def save_progress(self) -> None:
        ...
        try:
            ...
            data = {ach_id: ach.to_dict() for ach_id, ach in self.achievements.items()}
    ...
    def _on_achievement_unlocked(self, achievement: Achievement) -> None:
        ...
        logger.log_event(
            ...
            {"achievement_id": achievement.id, "achievement_name": achievement.name, "points": achievement.points},
        )
    ...
    def get_locked_achievements(self) -> List[Achievement]:
        ...
        return [ach for ach in self.achievements.values() if not ach.unlocked and not ach.hidden]
